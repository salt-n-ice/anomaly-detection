...
the rendered prompt, and the overlapping ground-truth labels.

What you do with the cases (grade them, sample them, score them, compare
them) is up to the research session. This script only produces the data.
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--suite", choices=["all", "60d", "120d", "30d"], default="all")
